...
const ResMenuCard = function ({resdata}) {
  return (
    <div className="flex justify-between items-center h-[200px] w-[1000px] my-6 border-t-2 border-gray-300">
      <div className="h-[165px] w-[640px]">
        <h4>🟢</h4>
        ...
        <p className="text-[19px] text-gray-500 font-[500]">{resdata.description}</p>
      </div>
      <div>
        <img
